...
#include "WallRun/Spikes.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSpikes() {}
// Cross Module References
	WALLRUN_API UClass* Z_Construct_UClass_ASpikes_NoRegister();
...
// End Cross Module References
	...
	template<> WALLRUN_API UClass* StaticClass<ASpikes>()
	{
		return ASpikes::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ASpikes);
	struct Z_CompiledInDeferFile_FID_WallRun_Source_WallRun_Spikes_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_WallRun_Source_WallRun_Spikes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpikes, ASpikes::StaticClass, TEXT("ASpikes"), &Z_Registration_Info_UClass_ASpikes, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpikes), 4033969221U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_WallRun_Source_WallRun_Spikes_h_1126487910(TEXT("/Script/WallRun"),
		Z_CompiledInDeferFile_FID_WallRun_Source_WallRun_Spikes_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_WallRun_Source_WallRun_Spikes_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
